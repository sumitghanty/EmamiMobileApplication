    ...
    return (
      <View style={styles.container}>
        ...
        <ScrollView contentContainerStyle={styles.scrollView}>
          <Text style={styles.title}>List of PJP pending for approval</Text>
          {sortList.length<1 ?
          ...
          <TouchableOpacity 
            ...
            //key={index} 
            onPress={() => this.props.navigation.navigate('PjpTripAprv'/*,item*/)}>
...
export default connect(mapStateToProps, mapDispatchToProps)(PjpTripListScreen);